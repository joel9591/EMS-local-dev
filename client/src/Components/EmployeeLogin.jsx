    ...
    <div className='d-flex justify-content-center align-items-center vh-100 loginPage'>
        <div className='p-3  rounded w-10 h-40 border loginForm'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button className='btn btn-success w-100 rounded-10 mb-2'>Log in</button>
                <div className='mb-1'> 
                    <input type="checkbox" name="tick" id="tick" className='me-2' onChange={(e) => setIsChecked(e.target.checked)}/>
                    <label htmlFor="password" className= {!isChecked && error ? 'text-danger' : 'text-white'}>You are Agree with terms & conditions</label>
                </div>
            </form>
        </div>
    </div>
